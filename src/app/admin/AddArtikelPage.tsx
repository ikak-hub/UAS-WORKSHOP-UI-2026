...
export default function AddArtikelPage({
  ...
  const [visibility, setVisibility] = useState<DraftStatus>("Draf");
  ...
  const handleSaveDraft = () => onSave({ title, content: body, category: categories, status: "Draf", wordCount });
  const handlePublish = () => onSave({ title, content: body, category: categories, status: "Published", wordCount });
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 300px", gap: 32, maxWidth: 1100 }}>
          ...
          <div>
            <input
              ...
              style={{ width: "100%", border: "1px solid #ddd", borderRadius: 4, padding: "14px 16px", fontFamily: "'Open Sans', sans-serif", fontWeight: 700, fontSize: 20, marginBottom: 20, outline: "none", boxSizing: "border-box" }}
            />
            ...
            <div style={{ border: "1px solid #ddd", borderRadius: 4 }}>
              ...
              <textarea
                ...
                style={{ width: "100%", minHeight: 480, border: "none", padding: "16px", fontFamily: "'Open Sans', sans-serif", fontSize: 15, resize: "vertical", outline: "none", boxSizing: "border-box" }}
              />
            </div>
          ...
          <div>
            ...
            <div style={{ border: "1px solid #ddd", borderRadius: 8, marginBottom: 20, overflow: "hidden" }}>
              ...
              <div style={{ padding: "16px" }}>
                <div style={{ display: "flex", gap: 8, marginBottom: 16 }}>
                  <button onClick={handleSaveDraft} style={{ flex: 1, border: "1px solid #ccc", borderRadius: 4, background: "#fff", padding: "7px 0", cursor: "pointer", fontFamily: "'Open Sans', sans-serif", fontSize: 13 }}>Save Draft</button>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 16 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    <svg width={16} height={16} viewBox="0 0 24 24" fill="none" stroke="#555" strokeWidth={2}><circle cx={12} cy={12} r={2} /><path d="M16.24 7.76a6 6 0 0 1 0 8.49M7.76 7.76a6 6 0 0 0 0 8.49" /></svg>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    ...
                    <span style={{ fontFamily: "'Open Sans', sans-serif", fontSize: 13 }}>
                      ...
                      <button onClick={() => setVisibility(v => v === "Draf" ? "Published" : "Draf")} style={{ background: "none", border: "none", color: "#0094F6", fontSize: 13, cursor: "pointer", textDecoration: "underline" }}>Edit</button>
                    </span>
                  </div>
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    <svg width={16} height={16} viewBox="0 0 24 24" fill="none" stroke="#555" strokeWidth={2}><rect x={3} y={4} width={18} height={18} rx={2} ry={2} /><line x1={16} y1={2} x2={16} y2={6} /><line x1={8} y1={2} x2={8} y2={6} /><line x1={3} y1={10} x2={21} y2={10} /></svg>
                    <span style={{ fontFamily: "'Open Sans', sans-serif", fontSize: 13 }}>
                      Publish immediately{" "}
                      <button style={{ background: "none", border: "none", color: "#0094F6", fontSize: 13, cursor: "pointer", textDecoration: "underline" }}>Edit</button>
                    </span>
                  </div>
                </div>

                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <button style={{ background: "none", border: "none", color: "#D00", fontSize: 13, cursor: "pointer", fontFamily: "'Open Sans', sans-serif" }}>Move to Trash</button>
            ...
            <div style={{ border: "1px solid #ddd", borderRadius: 8, overflow: "hidden" }}>
              ...
              <div style={{ padding: "12px 16px" }}>
                <div style={{ background: "#f5f5f5", borderRadius: 4, padding: "8px 12px", marginBottom: 8 }}>
                  <span style={{ fontFamily: "'Open Sans', sans-serif", fontSize: 13, color: "#666" }}>Categories</span>
                </div>
                {CATS.map((c, i) => (
...
// ─── Sub-komponen: Rich Text Toolbar ──────────────────────────────────────────
function RichToolbar() {
  const tools = ["B", "I", "Aa", "≡", "❝", "⬛", "⬜", "▦", "⇕", "🔗"];
  return (
    <div style={{ display: "flex", gap: 4, padding: "8px 12px", borderBottom: "1px solid #ddd", flexWrap: "wrap" }}>
      {tools.map((t, i) => (
        <button
          key={i}
          style={{ background: "none", border: "none", cursor: "pointer", padding: "4px 8px", fontSize: 15, borderRadius: 4, color: "#333" }}
          title={t}
        >
          {t}
        </button>
