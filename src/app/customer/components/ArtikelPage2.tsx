...
import ArtikelImport from "../../../imports/DetailArtikel-2/index";
...
export default function ArtikelPage2({ onHome, onArtikel, onArtikel1, onKatalog }: Props) {
  ...
  return (
    <ResponsiveCanvas>
      ...
      <div className="relative" style={{ width: 1728, height: 3285 }}>
        ...
        {/* Hamburger — over List icon (left=1664, top=209) in DetailArtikel-2 */}
        <button
          aria-label="Open menu"
          onClick={() => setMenuOpen(true)}
          style={{ position: "absolute", left: 1660, top: 205, width: 48, height: 48, zIndex: 100, background: "transparent", border: "none", cursor: "pointer", borderRadius: 8 }}
        />
      </div>
